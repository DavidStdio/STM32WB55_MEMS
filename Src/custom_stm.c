        ...
        case EVT_BLUE_GATT_READ_PERMIT_REQ:
        {
          ...
          if(read_permit_req->Attribute_Handle == (aMotenvContext.HWEnvCharHdle + 1U))
          {
            ...
            */
            ...
            Notification.Custom_Evt_Opcode = CUSTOM_ENV_READ_EVT;
          ...
          if(read_permit_req->Attribute_Handle == (aMotenvContext.HWAccEventCharHdle + 1U))
          {
            ...
            */
            ...
            Notification.Custom_Evt_Opcode  = CUSTOM_ACC_EVENT_READ_EVT;
            Custom_STM_App_Notification(&Notification);
          }
        ...
        case EVT_BLUE_GATT_ATTRIBUTE_MODIFIED:
       {
          ...
          if(attribute_modified->Attr_Handle == (aMotenvContext.HWEnvCharHdle + 2U))
          {
            ...
            */
            ...
            {
              Notification.Custom_Evt_Opcode = CUSTOM_ENV_NOTIFY_ENABLED_EVT;
              Custom_STM_App_Notification(&Notification);
            }
            else
            {
              Notification.Custom_Evt_Opcode  = CUSTOM_ENV_NOTIFY_DISABLED_EVT;
              Custom_STM_App_Notification(&Notification);
            }
          }
          ...
          if(attribute_modified->Attr_Handle == (aMotenvContext.HWAccEventCharHdle + 2U))
          {
            ...
            */
            if(attribute_modified->Attr_Data[0] & COMSVC_Notification)
            {
              Notification.Custom_Evt_Opcode   = CUSTOM_ACC_EVENT_NOTIFY_ENABLED_EVT;
              Custom_STM_App_Notification(&Notification);
            }
            else
            {
              Notification.Custom_Evt_Opcode    = CUSTOM_ACC_EVENT_NOTIFY_DISABLED_EVT;
              Custom_STM_App_Notification(&Notification);
            }
          }
          ...
          else if(attribute_modified->Attr_Handle == (aMotenvContext.HWMotionCharHdle + 2U))
          {
            ...
            */
            if(attribute_modified->Attr_Data[0] & COMSVC_Notification)
            {
              Notification.Custom_Evt_Opcode     = CUSTOM_MOTION_NOTIFY_ENABLED_EVT;
              Custom_STM_App_Notification(&Notification);
            }
            else
            {
              Notification.Custom_Evt_Opcode      = CUSTOM_MOTION_NOTIFY_DISABLED_EVT;
              Custom_STM_App_Notification(&Notification);
            }
          }
